...
export default function PublicVerifyPage({ onBack, initialLicenseNumber }) {
    ...
    async function verifyLicense(e) {
        ...
        try {
            const res = await fetch(`${API_BASE}/api/public/verify/${licenseNumber.trim()}`);
...
<head>
    ...
    <style>
        ...
        p { line-height: 1.6; font-size: 14px; margin: 8px 0; }
        .qr-section {
            margin-top: 24px;
            display: flex;
            align-items: center;
...
<body>
    <div class="certificate">
        ...
        <div class="qr-section">
            ...
            <div>
                <strong>Scan QR code to verify this license online.</strong>
            </div>
        </div>
