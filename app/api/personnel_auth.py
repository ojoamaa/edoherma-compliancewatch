...
from app.security.token import create_refresh_token
...
def read_personnel_me(
    current_personnel: Personnel = Depends(get_current_personnel),
):
    return {
        ...
        "facility_id": (
            str(current_personnel.facility_id)
            if current_personnel.facility_id
            else None
        ),
        "facility_name": (
            current_personnel.facility.facility_name
            if current_personnel.facility
            else None
        ),
        "lga": (
            current_personnel.facility.lga
            if current_personnel.facility
            else None
        ),
